...
| `USE_JAVA_VERSION`	|	Allows you to set the Java version used by the JNLP Client for the agent images. By default the value is set to `java-21`. To use Java 25, set the value for this env var to `java-25`.	|
